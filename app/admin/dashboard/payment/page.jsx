...
export default function PaymentPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch("/api/admin/pages/paynow", {
          credentials: "include",
        });
        if (!res.ok) throw new Error("Failed to load paynow data");
        ...
        toast.error("Could not load paynow data");
      } finally {
  ...
  async function onSubmit(values) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(err?.error || "Failed to save Payment data");
      }
  ...
  return (
    <div className="mx-auto w-full max-w-5xl p-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-xl">Payment Page</CardTitle>
          <CardDescription>
            Manage the Payment page content displayed on your website.
          </CardDescription>
        </CardHeader>
