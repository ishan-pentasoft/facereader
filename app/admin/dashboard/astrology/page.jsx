...
export default function AstrologyPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch("/api/admin/pages/astrology", {
          credentials: "include",
        });
        if (!res.ok) throw new Error("Failed to load astrology data");
        ...
        toast.error("Could not load astrology data");
      } finally {
  ...
  async function onSubmit(values) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(err?.error || "Failed to save astrology data");
      }
      ...
      toast.success("Astrology information saved successfully");
    } catch (e) {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl p-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-xl">Astrology Page</CardTitle>
          <CardDescription>
            Manage the astrology page content displayed on your website.
          </CardDescription>
        </CardHeader>
